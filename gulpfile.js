...
const def = gulp.series(clean, resources, htmlMinify, script, buildStyle, images, watchFiles)
export default def;

const prod = gulp.series(clean, resources, htmlMinify, buildStyles, scripts, images)
export { prod };

const dev = gulp.series(clean, resources, script, buildStyle, images, watchFiles)
export { dev };
